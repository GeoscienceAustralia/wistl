...
class EventTest2(unittest.TestCase):
    ...
    def test_no_time(self):
        self.assertEqual(self.scenario.no_time, 2)

        self.assertEqual(self.scenario.lines['LineA'].no_time, None)
        self.assertEqual(self.scenario.lines['LineB'].no_time, 2)
    ...
    def test_dmg_time_idx(self):
        ...
        self.assertEqual(self.scenario.lines['LineB'].dmg_time_idx, (479, 481))
